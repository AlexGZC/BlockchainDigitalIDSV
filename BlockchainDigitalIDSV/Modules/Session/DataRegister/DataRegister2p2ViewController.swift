//
//  DataRegister2p2ViewController.swift
...
class DataRegister2p2ViewController: UIViewController,NVActivityIndicatorViewable {
    ...
    @IBAction func registerAction(_ sender: Any) {
        ...
        if secureCode != ""{
            ...
            if self.adminTextfield.text?.isEmpty ?? true || (self.adminTextfield.text?.trimmingCharacters(in: .whitespaces).isEmpty)!{
